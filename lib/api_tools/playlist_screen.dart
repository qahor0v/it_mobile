...
import 'package:video_urok/api_tools/api_services.dart';
import 'package:video_urok/main.dart';
import 'package:video_urok/models/constants.dart';
import 'package:video_urok/utilites/youtube_player.dart';
import 'video_model.dart';

class LessonsList extends StatefulWidget {
  const LessonsList({required this.id, required this.appBarTitle});
